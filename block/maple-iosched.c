...
#define MAPLE_IOSCHED_PATCHLEVEL	(PC-10)

enum { ASYNC, SYNC };

/* Tunables */
static const int sync_read_expire = 400;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 850;	/* max time before a write sync is submitted. */
